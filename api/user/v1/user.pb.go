...
var file_api_user_v1_user_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xea, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x7f,
	...
	0x61, 0x0a, 0x07, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x12, 0x1b, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x52, 0x65, 0x70,
	...
	0x69, 0x74, 0x42, 0x2b, 0x0a, 0x0b, 0x61, 0x70, 0x69, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76,
...
var file_api_user_v1_user_proto_goTypes = []interface{}{
	...
	(*DepositRequest)(nil),        // 2: api.user.v1.DepositRequest
	(*DepositReply)(nil),          // 3: api.user.v1.DepositReply
}
var file_api_user_v1_user_proto_depIdxs = []int32{
	...
	2, // 1: api.user.v1.User.Deposit:input_type -> api.user.v1.DepositRequest
	1, // 2: api.user.v1.User.OpenCardHandle:output_type -> api.user.v1.OpenCardHandleReply
	3, // 3: api.user.v1.User.Deposit:output_type -> api.user.v1.DepositReply
